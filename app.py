...
st.markdown("""
    ...
    .chat-card { border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); margin-bottom: 12px; padding: 16px; background: #fff; max-width: 90%; }
    .user-msg { background: linear-gradient(90deg, #0b93f6 60%, #005bea 100%); color: #fff; text-align: right; }
    .assistant-msg { background: #f1f3f4; color: #222; text-align: left; }
    .avatar { width: 32px; height: 32px; border-radius: 50%; margin-right: 8px; vertical-align: middle; }
