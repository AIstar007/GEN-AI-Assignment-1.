...
st.markdown(f"""
    ...
    .summary-card {{ border-left: 6px solid #0b93f6; padding: 12px; border-radius: 8px; background: #fff; color: #ffffff; box-shadow: 0 2px 6px rgba(0,0,0,0.5); margin-bottom: 12px; line-height: 1.6; }}
